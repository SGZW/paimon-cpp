...
TEST(OffsetRowTest, TestSimple) {
    ...
    ASSERT_EQ(row.GetByte(0), (char)1);
    ASSERT_EQ(row.GetShort(1), (int16_t)11);
    ASSERT_EQ(row.GetInt(2), (int32_t)111);
    ASSERT_EQ(row.GetDate(2), (int32_t)111);
    ASSERT_EQ(row.GetLong(3), (int64_t)1111);
    ASSERT_EQ(row.GetFloat(4), (float)12.3);
    ASSERT_EQ(row.GetDouble(5), (double)12.34);
